export default function About() {
  return (
    <div style={{ maxWidth: 900, margin: "36px auto", padding: "0 20px" }}>
      ...
      <section style={{ marginTop: 20, background: "#fff", padding: 20, borderRadius: 8, border: "1px solid #eee" }}>
        <h3 style={{ marginTop: 0 }}>Why choose us</h3>
        <ul style={{ color: "#444" }}>
          <li>Local market expertise across Hyderabad neighbourhoods</li>
          <li>Verified property listings and honest pricing</li>
